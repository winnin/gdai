...
4. Start PostgreSQL (with pgvector) and RabbitMQ using docker-compose:
...
This project is licensed under the MIT License.# GDAI: Multi-Tenant Vector Store with Auditable Semantic Search
